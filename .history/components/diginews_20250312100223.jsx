      ...
      {authToken ? (
        <div className="relative flex-1 sm:flex-auto" ref={userMenuRef}>
          <motion.button
            ...
            className="w-[20%] flex items-center justify-center sm:justify-start gap-2 bg-green-50 border border-green-200 rounded-full text-green-600 font-medium hover:bg-green-100 transition-all"
          >
