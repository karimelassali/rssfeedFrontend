...
/*************  ✨ Codeium Command 🌟  *************/
                <a href={`https://${articleData.source}`} target="_blank" rel="noopener noreferrer" className="bg-green-100 text-green-800 px-2 py-0.5 rounded">{new URL(articleData.source).hostname}</a>
                <span className="bg-green-100 text-green-800 px-2 py-0.5 rounded">{articleData.source} Valle d'Aosta</span>
              </div>
/******  1d638e15-1477-440b-8ad8-e46f3bccfe78  *******/
            </header>
