...
import { Search, Filter, XCircle, X, <LockClosed></LockClosed>  , PenSquare, Loader2, ChevronDown, ChevronUp, Star } from "lucide-react";
          ...
          <div className="relative flex-1">
            ...
            {localStorage.getItem('authToken') || (
              <Link href="/login" className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-500">
                <LockClosed className="h-5 w-5" aria-hidden="true" />
              </Link>
            )}
