...
export default function DigiNews() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.log("Filtered data length:", filteredData.lengt      
      // Append new data to existing data if loadMorePage > 1
      setData(prevData => loadMorePage > 1 ? [...prevData, ...filteredData] : filteredData);
    } catch (err) {
