...
/*************  ✨ Codeium Command 🌟  *************/
                  {isEditing ? (
                    <input
                      type="text"
                      className="block w-full px-4 py-2 text-gray-600 border border-gray-300 rounded-md"
                      defaultValue="Il bambino di un anno e mezzo, investito ieri pomeriggio a Sarre insieme alla mamma e alla nonna, è stato trasferito all'ospedale Regina Margherita di Torino..."
                    />
                  ) : (
...
/******  9341b337-a074-4dbe-8804-5aaa735ae533  *******/
                </div>
              </div>
            </div>

            <div className="flex gap-4">
              <Button variant="outline" onClick={toggleEditing} className="flex-1 py-6">
                Modifica
              </Button>
