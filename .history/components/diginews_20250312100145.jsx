      ...
      {authToken ? (
        <div className="relative flex-1 sm:flex-auto" ref={userMenuRef}>
          <motion.button
            ...
            className="w-- flex items-center justify-center sm:justify-start gap-2 px-4 py-2 bg-green-50 border border-green-200 rounded-lg text-green-600 font-medium hover:bg-green-100 transition-all"
          >
