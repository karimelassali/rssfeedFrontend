                                ...
                                onClick={async () => {
                                  ...
                                  try {
                                    ...
                                    if (response.data.type === 'success') {
                                      ...
                                      toast.warning(response.data.message, { style: { backgroundColor: '#F7DC6F', color: 'black' } });
                                    }
                                  } catch (error) {
                                    toast.error('Errore durante l\'aggiunta ai preferiti', { style: { backgroundColor: '#FF3B30', color: 'white' } });
                                  }
                                }}
