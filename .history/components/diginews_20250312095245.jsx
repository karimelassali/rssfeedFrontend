  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <motion.header
        ...
        className="sticky top-0 z-10 bg-white/80 backdrop-blur-md rounded-b-xl p-4 md:p-6 border border-gray-100"
      >
        <div className="mx-auto max-w-[50%] bg-red-400 flex flex-col md:flex-row items-center justify-between gap-4">
          {/* Search Bar */}
          <div className="relative w-[50%] max-w-md md:max-w-lg flex items-center">
            <motion.input
              ref={inputRef}
              type="search"
              value={searchQuery}
