...
const WordPressImageFetcher = ({ apiUrl }) => {
  ...
  return (
    <div className="image-gallery grid  overflow-y-auto overflow-x-hidden max-h-[75vh] pr-4 pb-4 scrollbar-thin scrollbar-track-gray-300 scrollbar-thumb-gray-500 rounded-lg">
