...
/*************  ✨ Codeium Command 🌟  *************/
                <a className="bg-green-100 text-green-800 px-2 py-0.5 rounded" href={`https://${articleData.source}`} target="_blank" rel="noopener noreferrer">{new URL(`https://${articleData.source}`).hostname}</a>
                <span className="bg-green-100 text-green-800 px-2 py-0.5 rounded">{articleData.source} Valle d'Aosta</span>
              </div>
/******  a84ac34f-2410-473b-a8a2-8e5abe9e8d57  *******/
            </header>
