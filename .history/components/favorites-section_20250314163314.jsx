...
export default function FavoritesSection({ favoriteSources }) {
  ...
  const confirmDelete = async () => {
    ...
    setDeletingSourceId(favoriteToDelete.id)
    try {
                ...
                <motion.div
                  ...
                  <div
                    ...
                    <Button
                      ...
                      disabled={deletingSourceId === favorite.id}
                      className="text-gray-500 hover:text-red-500 hover:bg-red-50 transition-colors relative">
                      {deletingSourceId === favorite.id ? (
