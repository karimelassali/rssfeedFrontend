      ...
      try {
        const response = await axios.get(`/api/articles`, {
          params: {
            page,
            pageSize,
            activeFilters: JSON.stringify(activeFilters), // Ensure filters are properly serialized
            search: searchQuery
          },
        });
        ...
        // Check if we received fewer items than requested, indicating we've reached the end
