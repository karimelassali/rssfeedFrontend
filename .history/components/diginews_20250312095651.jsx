...
export default function DigiNews() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      >
        <div className="mx-auto max-w-[50%] bg-red-400 flex max-sm:w-full  items-center justify-between gap-4">
          {/* Search Bar */}
          <div className="relative w-[50%] max-w-md md:max-w-lg max-sm:w-full flex items-center">
            <motion.input
              ref={inputRef}
              type="search"
              value={searchQuery}
