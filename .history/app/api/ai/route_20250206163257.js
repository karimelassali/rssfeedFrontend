...
/*************  ✨ Codeium Command 🌟  *************/
    const prompt = `Always summarize this feed description in 5-9 lines and extract its location. Ensure the response is clean JSON format without any additional formatting. Here is the prompt:\n\nTitle: ${articleTitle}\nDescription: ${articleDescription}`;
...
/******  9b253ec5-601a-4187-8976-4a6cfb76a035  *******/
